...
```
![alt text](<create table mahasiswa.png>)
**Tampilkan hasil table :**

`desc Mahasiswa;`


![alt text](<Screenshot 2024-04-30 005459.png>)
...
```
![alt text](<Screenshot 2024-04-30 005619.png>)

**Tampilkan tabel :**

`desc Dosen;`

![alt text](<Screenshot 2024-04-30 005658.png>)
...
![alt text](<Screenshot 2024-04-30 010148.png>)

**Tampilkan table :**

`desc Matakuliah;`

![alt text](<Screenshot 2024-04-30 010216.png>)
...
![alt text](<Screenshot 2024-04-30 010535.png>)

**Tampilkan table :**

`desc JadwalMengajar;`
![alt text](descjadwalmengajar.png)
...
![alt text](<create table krs.png>)

**Tampilkan table :**


![alt text](<Screenshot 2024-04-30 010653.png>)
...
```
![alt text](<Screenshot 2024-04-30 010809.png>)

**2. Menampilkan semua isi/record pada tabel bisa menggunakan kode berikut :**

`select*from Mahasiswa;`
![alt text](<Screenshot 2024-04-30 010901.png>)
...
![alt text](<Screenshot 2024-04-30 011014.png>)
...
![alt text](<Screenshot 2024-04-30 011410.png>)
...
```
![alt text](<Screenshot 2024-04-30 011602.png>)
...
`INSERT INTO Mahasiswa (nim, nama, alamat) VALUE ('1234','Afryan','Bekasi');`
![alt text](<Screenshot 2024-04-30 011951.png>)
...
`SELECT*FROM Mahasiswa;`
![alt text](<Screenshot 2024-04-30 012016.png>)
...
`UPDATE Mahasiswa SET nama='Naya', alamat='Ksb' WHERE nim='1234';`
![alt text](<Screenshot 2024-04-30 012057.png>)
...
![alt text](<Screenshot 2024-04-30 012107.png>)
